...
class MiMenu(Menu):
    def __init__(self):
        ...
        item4 = EntryMenuItem("Dificultad (1-10): ", self.eleccion_dificultad, "", max_length=2)
        item5 = ImageMenuItem("goku.png", self.on_image_callback)
...
def main():
    # Desactivar la inicialización del audio
    director.init(width=800, height=600, caption="Menú Principal", audio=False)
    director.window.set_location(500, 200)
